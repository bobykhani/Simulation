...
public class AppExample {
	...
	public static void main(String[] args) throws Exception {
		...
		for (MobileDevice st : getSmartThings()) {
			List <ApDevice> gap = getApDevices();
		...
		for (FogBroker br : getBrokerList()) {
			...
			AppModule uvm = (AppModule) getSmartThings().get(i).getVmMobileDevice();
			MobileDevice uvmm =  getSmartThings().get(i);
	...
	private static Application createApplication(String appId, int userId,
		...
		String dest = userVm.getName();
		application.addAppEdge("client" + myId, dest, 966, 54,
